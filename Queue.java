...
public class Queue {
    ...
    /**
     * Gets the index of the first instance of a Song in the queue
     * Returns -1 if
     * */
    public int getSongIndex(String pSongName){
        assert pSongName!=null;
        int i=0;
        for(Song s: aSongElements){

            if(s.getName().equals(pSongName)){
                return i;
            }
            i++;
        }
